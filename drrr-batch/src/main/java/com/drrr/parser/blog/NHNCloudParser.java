...
@Configuration
public class NHNCloudParser {

    @Bean
    Parser nhnCloudContentsParser(WebDriverPool webDriverPool) {

        return SimpleParser.builder()
                .webDriverPool(webDriverPool)
                .techBlogCode(TechBlogCode.NHN_CLOUD)
                .target(By.className("tui-editor-contents"))
                .build();
    }
}
