...
public record TechBlogPostCategoryDto(
    ...
    public static Comparator<TechBlogPostCategoryDto> orderByTopBlogTypeCondition(final TopTechBlogType type) {
        if (type.equals(TopTechBlogType.VIEWS)) {
            ...
            return Comparator.comparingInt((TechBlogPostCategoryDto o) -> o.techBlogPostBasicInfoDto().viewCount())
                    .reversed();
        }
        return Comparator.comparingInt((TechBlogPostCategoryDto o) -> o.techBlogPostBasicInfoDto().postLike())
                .reversed();
    }
}
