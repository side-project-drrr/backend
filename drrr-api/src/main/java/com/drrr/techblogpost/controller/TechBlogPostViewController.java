...
import com.drrr.techblogpost.service.ExternalUnsignedMemberPostService;
...
public class TechBlogPostViewController {
    private final ExternalUnsignedMemberPostService externalUnsignedMemberPostService;
    ...
    public void UnsignedMemberPostViewIncrement(@NotNull @PathVariable(name = "postId") final Long postId) {
        externalUnsignedMemberPostService.increaseViewCount(postId);
    }
}
