package com.example.drrrapi.web.security.config;


import com.example.drrrapi.web.jwt.util.JwtProvider;
import com.example.drrrapi.web.security.filter.JwtTokenValidationFilter;
...
public class SecurityConfig {
    private static List<String> clients = Arrays.asList("kakao", "github");
